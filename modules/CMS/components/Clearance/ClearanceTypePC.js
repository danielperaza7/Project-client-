...
import styles from "./clearanceTypePC.css";

class ClearanceTypePC extends Component {
  constructor(props) {
    super(props);
    this.state = {
      error: ""
  ...
  renderSizeCardList() {
        ...
        <div key={i + clearanceSizeType.componentName} className={styles.sizeCard}>
          {product_type == "1" ? (
            <div className={styles.componentName}>
              <span>
                {`${
                  clearanceSizeType.componentName
                    ? `${clearanceSizeType.componentName}:`
                    : ""
                }`}
              </span>
          ...
          <div
            style={{
              marginLeft: product_type != "1" ? "48px" : "",
              display: "inline-flex"
            }}
          >
    ...
    return (
      <div className={styles.sizeDetail}>
        <h2 className={styles.sizeDetail_title}>
  ...
  render() {
    ...
    return (
      <div
        className={styles.clearanceTypePC}
        style={{
          fontFamily:
            language === "en" ? "GothamBook !important" : "PingFang SC !important"
        }}
      >
...
export default ClearanceTypePC;
